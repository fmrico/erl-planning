#include "erl_planning/actions/RP_escort_to.h"

/* The implementation of RP_escort_to.h */
namespace KCL_rosplan {

	/* constructor */
	RP_escort_to::RP_escort_to(ros::NodeHandle &nh, std::string &actionserver)
	...
	bool RP_escort_to::concreteCallback(const rosplan_dispatch_msgs::ActionDispatch::ConstPtr& msg) {
		...
		{
			ROS_INFO("KCL: (%s) moving to", wpID.c_str());
		}
	...
	int main(int argc, char **argv) {
		...
		ros::init(argc, argv, "rosplan_interface_escort_to");
		ros::NodeHandle nh("~");
		...
		KCL_rosplan::RP_escort_to rpmb(nh, actionserver);
