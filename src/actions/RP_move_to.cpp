#include "erl_planning/actions/RP_move_to.h"

/* The implementation of RP_move_to.h */
namespace KCL_rosplan {

	/* constructor */
	RP_move_to::RP_move_to(ros::NodeHandle &nh, std::string &actionserver)
	...
	int main(int argc, char **argv) {
		...
		KCL_rosplan::RP_move_to rpmb(nh, actionserver);
